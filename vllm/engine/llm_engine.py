...
class LLMEngine:
    ...
    def __init__(
        ...
        if not self.model_config.skip_tokenizer_init and model_config.tokenizer_mode != "cpm":
            ...
            self.detokenizer = Detokenizer(self.tokenizer, model_config.tokenizer_mode) 
        else:
            self.tokenizer = None
        ...
        if self.tokenizer and  model_config.tokenizer_mode != "cpm":
    ...
    def process_model_inputs(
        ...
        if "prompt_token_ids" not in inputs:
            ...
            if self.model_config.tokenizer_mode == "cpm":
                prompt_token_ids = [tokenizer.bos_id] + tokenizer.encode(inputs["prompt"])
                #print("cpm: ", prompt_token_ids)
            else:

                prompt_token_ids = tokenizer.encode(request_id=request_id,
                                                prompt=inputs["prompt"],
                                                lora_request=lora_request)
                #print("normal: ", prompt_token_ids)
        else:
